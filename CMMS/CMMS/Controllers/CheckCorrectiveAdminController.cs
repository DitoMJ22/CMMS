...
{
    public class CheckCorrectiveAdminController : Controller
    {
        ...
        public ActionResult WOCAccept(string id)
        {
            ...
            TempData["Direct"] = "CheckCorrectiveAdmin";
            if (id != null)
            {
            ...
            return RedirectToAction("CheckCorrectiveAdmin");
        }
        ...
        public ActionResult WOCReject(string id)
        {
            ...
            TempData["Direct"] = "CheckCorrectiveAdminReject";
            if (id != null)
            {
                id = _corrective.setWorkOrderCorrectiveID(id);
                TempData["Data"] = _corrective.getWorkOrderID(id);
